...
COPY static/favicon.svg static/favicon.ico static/patch-favicon.py /usr/local/share/xd/
RUN sed -i 's/\r$//' /usr/local/share/xd/patch-favicon.py \
    && python3 /usr/local/share/xd/patch-favicon.py
